...
public class NotificationUtils {
    ...
    private static android.support.v7.app.NotificationCompat.Action ignoreReminderAction(Context context){
    ...
    //      TODO (9) Create an Action for the user to ignore the notification (and dismiss it)
        android.support.v7.app.NotificationCompat.Action ignoreRemonderAction = new NotificationCompat.Action(
                R.drawable.ic_cancel_black_24px,
                "No thanks!",
                ignoreReminderPendingIntent
        );
    //      TODO (10) Return the action
        return ignoreRemonderAction;
    }

    private static android.support.v7.app.NotificationCompat.Action drinkWaterAction (Context context){
    ...
    //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        android.support.v7.app.NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
