...
public class MainActivity extends AppCompatActivity {
    ...
    private int mCurrentState,mCurrrentWord,mCurrentDefintion;
    ...
    public void nextWord() {
        ...
        if(mData != null) {
            ...
            mWord.setText(mData.getString(mCurrrentWord));
            mDefinition.setText(mData.getString(mCurrentDefintion));
            Log.v("TERM:" , "Word: "+ mData.getString(mCurrrentWord)
                    + "Definition: " + mData.getString(mCurrentDefintion));
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            super.onPostExecute(cursor);
               ...
               mCurrrentWord =  mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD);
              mCurrentDefintion = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
