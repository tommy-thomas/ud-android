...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_RESULT_JSON = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( savedInstanceState != null ){
            ...
            String jsonResult = savedInstanceState.getString(SEARCH_RAW_RESULT_JSON);
    ...
    public void onSaveInstanceState(Bundle outState){
        ...
        outState.putString(SEARCH_RAW_RESULT_JSON , jsonResult);
    }
