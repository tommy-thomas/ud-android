...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int SYNC_FELEXTIME_SECONDS = REMINDER_INTERVAL_SECONDS;

    private static boolean sInitialized;

    //  TODO (11) Add a sync tag to identify our sync job
    private static final String WEATHER_SYNC_TAG = "weather-sync-tag";

    //  TODO (12) Create a method to schedule our periodic weather sync
    synchronized public static void scheduleWeatherSyncTask(@NonNull final Context context){
        if(sInitialized){
            return;
        }
        ...
        Job weatherSyncReminderJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        ...
                        REMINDER_INTERVAL_SECONDS + SYNC_FELEXTIME_SECONDS
                ))
                .setReplaceCurrent(true)
                .build();
        dispatcher.schedule(weatherSyncReminderJob);
        sInitialized = true;
    }
    /**
