...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String defaultLocation = sharedPreferences.getString("location" , getDefaultWeatherLocation());
    ...
    public static boolean isMetric(Context context) {
        ...
        String units = sharedPreferences.getString("units" , "imperial");

        if( units !="" && units != null && units == "metric"){
            return true;
        }
