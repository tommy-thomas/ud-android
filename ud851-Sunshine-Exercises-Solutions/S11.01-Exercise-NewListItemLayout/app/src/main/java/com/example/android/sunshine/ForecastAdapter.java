...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.weatherLowTemp.setText(lowTemp);
        forecastAdapterViewHolder.weatherHighTemp.setText(highTemp);
    }
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        ...
        final TextView weatherHighTemp;
        final TextView weatherLowTemp;
...
//          TODO (6) Get references to all new views and delete this line
            ...
            weatherDescription = (TextView) view.findViewById(R.id.tv_description);
            weatherHighTemp = (TextView) view.findViewById(R.id.tv_high_temperature);
            weatherLowTemp = (TextView) view.findViewById(R.id.tv_low_temperature);
