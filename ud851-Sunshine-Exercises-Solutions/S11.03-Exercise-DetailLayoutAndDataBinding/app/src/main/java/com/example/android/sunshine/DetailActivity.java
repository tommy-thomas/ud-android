...
//      TODO (15) Create the content description for the description for a11y
        String descriptionA11 = getString(R.string.a11y_forecast, description);
...
//        mDescriptionView.setText(description);
        ...
        mDetailBinding.primaryInfo.weatherDescription.setContentDescription(descriptionA11);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryInfo.weatherIcon.setContentDescription(descriptionA11);
...
//        mHumidityView.setText(humidityString);
        ...
        mDetailBinding.extraDetails.humidity.setContentDescription(highA11y);

//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraDetails.humidityLabel.setContentDescription(highA11y);
